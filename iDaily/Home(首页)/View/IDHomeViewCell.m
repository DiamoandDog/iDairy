...
//    for (IDDetailModel *news in self.detail) {
//        CLLocationCoordinate2D coordinate;
//        coordinate.latitude = [news.latitude doubleValue];
//        coordinate.longitude = [news.longitude doubleValue];
