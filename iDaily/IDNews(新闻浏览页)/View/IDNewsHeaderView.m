...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        UILabel *sourceLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, IDScreemSize.width - 20, 20)];
        ...
        UILabel *dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(titleLabel.bounds), IDScreemSize.width - 20, 20)];
